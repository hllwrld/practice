...
fun covariant(){
    ...
    val eduBookStore1: BookStore<EduBook> = BookStore()
    val bookStore1: BookStore<Book> = eduBookStore1
...
fun contravariant(){
    ...
    val dustbin1: Dustbin<Waste> = Dustbin()
    val dryDustBin1: Dustbin<DryWaste> = dustbin1
